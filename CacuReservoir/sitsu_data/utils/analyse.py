...
def analyze_dataset():
    ...
    for param in parameters:
        ...
        plt.title(f"Distribuição de {param}", pad=20, fontsize=12)
        ...
        plt.title(f"Boxplot de {param} por Ponto de Amostragem", pad=20, fontsize=12)
    ...
    sns.heatmap(corr_matrix, 
                ...
                linewidths=0.5,
                cbar_kws={"shrink": .5})
    plt.title("Matriz de Correlação entre Parâmetros", pad=20, fontsize=12)
